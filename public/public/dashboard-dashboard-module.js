...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent() {
        ...
        for (var i = 0; i < 31; i++) {
            ...
            var daySales = Math.floor(Math.random() * (2000 - 1500 + 1) + 1500);
